...
export class Broker {
  ...
  async doctor({ attachmentRoot = null } = {}) {
    ...
    return { version: 4, material_protocol: MATERIAL_PROTOCOL, capabilities: { attachments: attachmentRootStatus.status !== "unavailable", cancel_source: true }, attachment_root: attachmentRootStatus, verification: attachmentVerification, note: "doctor does not verify model authentication or a real review", providers: output };
  }
