...
export function createHealthRunner({ probeSession = null, intervalMs = 60_000, probeDeadlineMs = 5_000, probeAbortGraceMs = 50, clock = realClock, isCancelled = () => false, validateCompleted = () => true, onDecision = () => {} } = {}) {
  let timer = null; let deadline = null; let activeProbe = null; let stopped = false; let generation = 0; let cursor = null; let session_id = null; let unverifiable = 0; let stagnant = 0; let fallbackGeneration = 0;
