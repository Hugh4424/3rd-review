...
export function planDelivery(worker, checked, prompt, maxPromptBytes) {
  ...
  if (checked.requested_delivery === "file_only") {
    return { delivery_mode: "file_only", provider_prompt: prompt, material_manifest_hash: checked.manifest_hash, material_total_bytes: checked.total_bytes, provider_visible_attachment_manifest };
  }
