...
const bindingFields = ["sequence", "bundle_id", "manifest_hash", "delivery_manifest_hash", "initial_material_manifest_hash", "provider_material_manifest_hash", "provider_delivery_manifest_hash", "provider_initial_material_manifest_hash"];
