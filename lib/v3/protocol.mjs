...
export function validateRequest(request, { maxInputBytes = 524_288 } = {}) {
  ...
  if (!isPlainObject(request.overrides ?? {}) || Object.keys(request.overrides ?? {}).length !== 0) throw invalid("overrides must be an empty object; provider policy belongs in global config");
