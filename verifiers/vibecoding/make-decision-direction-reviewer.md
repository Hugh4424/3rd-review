...
1. `make-decision-reviewer-contract.md` (direction section) — direction review dimensions, blocking rules, review discipline (including frame-challenge function).
